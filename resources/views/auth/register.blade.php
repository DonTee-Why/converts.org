    ...
    <div class="flex flex-col grid md:grid-cols-7 p-6">
        <div class="md:col-start-3 md:col-span-3">
            <div class="bg-gray-800 rounded-t-md justify-center p-4 ">
                <p class="text-2xl text-white font-bold text-center">ADD NEW USER</p>
            </div>
                ...
                <form action="{{ route('addUser') }}" method="POST">
                    ...
                    <div class="mb-5">
                        ...
                        <input type="password" name="password_confirmation" id="password_confirmation"
                            ...
                            class="bg-gray-100 border-l-8  border-gray-600 w-full p-3 rounded-sm @error('password_confirmation') border-red-500 @enderror">
                    ...
                    @if ($status ?? '' == 1)
                        <div class="bg-green-500 text-white my-3 p-2 text-lg" role="alert">
